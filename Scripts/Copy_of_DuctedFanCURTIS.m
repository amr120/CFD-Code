...
if write_pv == 1
    ...
    for n = 1:length(leg)
        ...
        ts_export_paraview(g,[dr.pv des_name '_rotors' num2str(n) '.hdf5'],'HighSpeed',[0:6],1);
        ts_export_paraview(g,[dr.pv des_name '_stators' num2str(n) '.hdf5'],'HighSpeed',[7:13],1);
